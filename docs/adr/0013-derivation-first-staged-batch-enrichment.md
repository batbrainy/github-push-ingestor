...
PR #43's durable backlog (plan Appendix F) fixed the wrong-outcome problem — quota
...
Appendix A's cold-demand pressure sample of roughly 2,172–2,280 entity references per
