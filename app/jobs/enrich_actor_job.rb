...
# §10's fairness policy and a FOR UPDATE SKIP LOCKED lease, newest-first. An id-addressed job
# would have to bypass that ordering to honour its argument, which is how a repository flood
# starves actors. So the job says "do one actor's worth of work" and the runner decides
# whose — which is also why a duplicate delivery is harmless: it is one more cycle, and it
# finds either different work or none.
#
